        ...
        if self.use_spikein:
            if len(self.spikein_reads) > 0:
                for i,t in enumerate(self.times):
                    ...
                    # print('self.spikein_reads[t]', self.spikein_reads[t])
                    # print('self.spikein_reads[t].sum()', self.spikein_reads[t].sum())
                    # print('self.spikein_abundance_observed', self.spikein_abundance_observed)
                    abs[:,i] = raw[:,i] / self.spikein_reads[t].sum() * self.spikein_abundance_observed
